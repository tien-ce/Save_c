...
int size_new;
if(huffcode.size()%8==0)
size_new=huffcode.size()/8;
else
size_new=(huffcode.size()/8)+1;	
...
delete []new_mes;
const char file_name[] = "example.zip"; 
